...
INSTALLED_APPS = [
    ...
    "rest_framework", "django_extensions", "apps.elecciones", "apps.asistencia", "apps.usuarios", "apps.auditoria", "apps.reportes", "apps.padron", "apps.justificativos", "apps.autoridades",
]
MIDDLEWARE = [
